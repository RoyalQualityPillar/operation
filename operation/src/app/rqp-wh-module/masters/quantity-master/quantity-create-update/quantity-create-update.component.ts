...
@Component({
  selector: 'app-quantity-create-update',
  standalone: false,
  templateUrl: './quantity-create-update.component.html',
  styleUrl: './quantity-create-update.component.scss'
})
export class QuantityCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<QuantityCreateUpdateComponent>,
