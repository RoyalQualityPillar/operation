...
export class PpService {
  ...
  public PlanOrderMrpList(unitCode: string): Observable<any> {
   ...
   public getReservedMaterialList(unitCode: string): Observable<any> {
    return this.http.get(this.API_URL + `pp/reserved-material-list?unitCode=${unitCode} `);
  }
  ...
  public getMaterialCompletedProductionList(Unitcode: string): Observable<any> {
   ...
   public getFGMaterialCompletedProductionList(Unitcode: string): Observable<any> {
    return this.http.get(this.API_URL + `pp/fg-material-completed-production-list?Unitcode=${Unitcode} `);
  }
