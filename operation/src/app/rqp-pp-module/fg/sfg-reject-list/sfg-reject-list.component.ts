...
private ppService:PpService,
 private cookieService: CookieService,
  ...
  ngOnInit(): void {
   ...
   this.ppService.getSFGRejectList(unitCode).subscribe((data: any) => {
        this.dataSource = data.data;
        this.sfgRejectListData = new MatTableDataSource(this.dataSource);
        this.sfgRejectListData.sort = this.sort;
        this.sfgRejectListData.paginator = this.paginator;
      });
}
 public pageChanged(event): void {
    if (this.sfgRejectListData.length == GlobalConstants.size) {
      if (
