...
@Component({
  selector: 'app-sfg-execution-process-order',
  standalone: false,
  templateUrl: './sfg-execution-process-order.component.html',
  styleUrl: './sfg-execution-process-order.component.scss'
})
export class SfgExecutionProcessOrderComponent implements OnInit {
