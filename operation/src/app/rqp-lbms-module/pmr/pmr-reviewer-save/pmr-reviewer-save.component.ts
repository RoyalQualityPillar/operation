...
@Component({
  selector: 'app-pmr-reviewer-save',
  standalone: false,
  templateUrl: './pmr-reviewer-save.component.html',
  styleUrl: './pmr-reviewer-save.component.scss'
})
export class PmrReviewerSaveComponent implements OnInit {
  public redirectUrl: string = '/rqpoperationui/lbms/pmr-module-admin';
