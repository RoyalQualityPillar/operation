...
@Component({
  selector: 'app-cum-create-update',
  standalone: false,
  templateUrl: './cum-create-update.component.html',
  styleUrl: './cum-create-update.component.scss'
})
export class CumCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CumCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.cumLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
