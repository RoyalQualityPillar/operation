...
@Component({
  selector: 'app-create-update-equip-inst-master',
  standalone: false,
  templateUrl: './create-update-equip-inst-master.component.html',
  styleUrl: './create-update-equip-inst-master.component.scss'
})
export class CreateUpdateEquipInstMasterComponent implements OnInit, OnDestroy {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CreateUpdateEquipInstMasterComponent>,
    ...
    this.DepartmentMaster = this.fb.group({
      ...
      ff0017: ['', Validators.required],
      ff0018: ['', Validators.required],
      createdby: [''],
      status: [''],
  ...
  onLoadStatusDropDown() {
    this.isLoading = true;
    this.equipInstMasterService.getDropDownList().subscribe((data: any) => {
  ...
  onLoadFormValue() {
    ...
    const params = { UC0001 };
    this.apiService
      .sendRequest(apiEndPoints.equipmentInustumentMasterLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
