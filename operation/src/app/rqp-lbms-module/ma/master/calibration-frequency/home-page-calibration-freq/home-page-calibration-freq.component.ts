...
@Component({
  ...
  standalone: false,
  templateUrl: './home-page-calibration-freq.component.html',
  styleUrl: './home-page-calibration-freq.component.scss'
})
export class HomePageCalibrationFreqComponent implements OnInit, AfterViewInit {
