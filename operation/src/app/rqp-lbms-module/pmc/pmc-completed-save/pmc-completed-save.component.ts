...
@Component({
  selector: 'app-pmc-completed-save',
  standalone: false,
  templateUrl: './pmc-completed-save.component.html',
  styleUrl: './pmc-completed-save.component.scss'
})
export class PmcCompletedSaveComponent implements OnInit {
  public redirectUrl: string = '/rqpoperationui/lbms/pmc-module-admin';
  ...
  getPMMCdIndexList(lc0002: any) {
   ...
   public downloadPMCAttachedReport() {
    // const lcNumber = this.headerData?.lcnum;
    // const templateName = 'cc.html';
    // const moduleCode = this.headerData?.modulecode;
    // const lcrnumber = this.headerData.requestNo;
