...
@Component({
  selector: 'app-pmc-reviewer-save',
  standalone: false,
  templateUrl: './pmc-reviewer-save.component.html',
  styleUrl: './pmc-reviewer-save.component.scss'
})
export class PmcReviewerSaveComponent implements OnInit {
