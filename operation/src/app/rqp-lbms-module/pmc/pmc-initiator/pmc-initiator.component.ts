...
@Component({
  selector: 'app-pmc-initiator',
  standalone: false,
  templateUrl: './pmc-initiator.component.html',
  styleUrl: './pmc-initiator.component.scss'
})
export class PmcInitiatorComponent implements OnInit {
