...
import { DmproductCreateUpdateComponent } from '../dmproduct-create-update/dmproduct-create-update.component';
import { DmsAddNewRecordComponent } from '../../dms-add-new-record/dms-add-new-record.component';

@Component({
  selector: 'app-dmproduct-home-page',
  templateUrl: './dmproduct-home-page.component.html',
  styleUrl: './dmproduct-home-page.component.scss',
  standalone: false,
})
export class DmproductHomePageComponent implements OnInit, AfterViewInit {
