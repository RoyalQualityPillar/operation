...
import { PmsListComponent } from '../dms/pms-list/pms-list.component';
...
@Component({
  selector: 'app-dms-add-new-record',
  standalone: false,
  templateUrl: './dms-add-new-record.component.html',
  styleUrl: './dms-add-new-record.component.scss'
})
export class DmsAddNewRecordComponent implements OnInit {
  public psmList: any[] = [];
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DmsAddNewRecordComponent>,
  ) { }
  ngOnInit(): void {
